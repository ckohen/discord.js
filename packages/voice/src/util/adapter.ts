...
/**
 * Methods that are provided by the \@ckohen/voice library to implementations of
...
export interface DiscordGatewayAdapterImplementerMethods {
	/**
	 * This will be called by \@ckohen/voice when the adapter can safely be destroyed as it will no
	 * longer be used.
	 */
	destroy(): void;
	/**
